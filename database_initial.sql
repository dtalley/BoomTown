...
SELECT pg_catalog.setval(pg_catalog.pg_get_serial_sequence('bases', 'base_id'), 2, true);
...
SELECT pg_catalog.setval(pg_catalog.pg_get_serial_sequence('command_bases', 'command_base_id'), 8, true);
...
SELECT pg_catalog.setval(pg_catalog.pg_get_serial_sequence('command_factions', 'command_faction_id'), 6, true);
...
SELECT pg_catalog.setval(pg_catalog.pg_get_serial_sequence('command_ranks', 'command_rank_id'), 2, true);
...
SELECT pg_catalog.setval(pg_catalog.pg_get_serial_sequence('commanders', 'commander_id'), 9, true);
...
SELECT pg_catalog.setval(pg_catalog.pg_get_serial_sequence('extensions', 'extension_id'), 3, true);
...
SELECT pg_catalog.setval(pg_catalog.pg_get_serial_sequence('factions', 'faction_id'), 3, true);
...
SELECT pg_catalog.setval(pg_catalog.pg_get_serial_sequence('ranks', 'rank_id'), 1, true);
...
SELECT pg_catalog.setval(pg_catalog.pg_get_serial_sequence('scenarios', 'scenario_id'), 1, true);
...
SELECT pg_catalog.setval(pg_catalog.pg_get_serial_sequence('territories', 'territory_id'), 1, false);
...
SELECT pg_catalog.setval(pg_catalog.pg_get_serial_sequence('territory_statuses', 'territory_status_id'), 4, true);
...
SELECT pg_catalog.setval(pg_catalog.pg_get_serial_sequence('zone_scenarios', 'zone_scenario_id'), 1, false);
...
SELECT pg_catalog.setval(pg_catalog.pg_get_serial_sequence('zone_statuses', 'zone_status_id'), 3, true);
...
SELECT pg_catalog.setval(pg_catalog.pg_get_serial_sequence('zones', 'zone_id'), 1, false);
...
1	Norton-McDowell Industries	A corporation.	0	NOMAD	norton-mcdowell_industries
2	The Environmental Liberation Force	An environmentally conscious group.	0	ELF	the_environmental_liberation_force
3	The Global Defense and Assault Movement	A private military	0	GDAM	the_global_defense_and_assault_movement
\.
...
2011-03-23 17:59:03	2011-03-23 17:59:03	-6	Logan Long	Logan	Long	11/04/1985	loganlong@gmail.com	2011-03-23 17:59:03	678450388	YmMVYb9v9h3Dvr2xdZG9QPRBQuiCKT5t
2011-03-22 06:23:22	2011-03-22 06:23:22	-7	David Talley	David	Talley	03/27/1986	dtalley@gmail.com	2011-03-29 06:08:58	804640510	YmMVYb9v9h3Dvr2xdZG9QPRBQuiCKT5t
2011-03-29 19:41:07	2011-03-29 19:41:07	-7	Patricia Ambbfjbabhdj Smithberg	Patricia	Smithberg	04/12/1980	pnvqzds_smithberg@tfbnw.net	2011-04-02 20:22:03	100002260212840	YmMVYb9v9h3Dvr2xdZG9QPRBQuiCKT5t
\.
